		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IDoc Manager OrderSP ",
									"targetURL": "#comidocmanagerorderspui01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comidocmanagerorderspui01-display": {
								"semanticObject": "comidocmanagerorderspui01",
								"action": "display",
								"description": "IDoc Manager Basic Fiori Application",
								"title": "IDoc Manager OrderSP ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.idocmanagerorderspui01",
									"url": sap.ui.require.toUrl("com/idocmanagerorderspui01")
								}
							}
						}
					}
